...
function ProductCard({ movie, onButtonClick, buttonText }) {
  ...
  // TODO: search a better way to resolve the "problem" of the alert
  // const handleAction = async (actionType) => {
    ...
    //     alert("Película añadida correctamente 🎬"); // !sino el fetch se hace muy rapido no llega a gregar la nueva pelicula
    //     fetchMovies();
    //   } catch (error) {
